  ...
  return (
    <section className="w-full bg-black py-12">
      <div className="mx-auto flex max-w-3xl flex-col items-center px-5 text-center lg:px-10">
        <h2 className="font-display text-2xl text-white lg:text-3xl">¿Necesitás asesoramiento legal?</h2>
        <p className="mt-2 text-sm text-white/70 lg:text-base">Analizamos tu caso y te respondemos a la brevedad.</p>
